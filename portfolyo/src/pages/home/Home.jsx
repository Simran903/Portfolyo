...
const Home = () => {
    ...
    const imageY = 100; // Center of the rectangle vertically
        ...
        <div id="home" className="xl:mx-40 my-10 flex flex-col lg:grid lg:grid-cols-2 max-sm:h-full max-sm:mt-40">
            <div className="flex flex-col text-center xl:text-left justify-center items-center xl:items-start tracking-wider mt-20">
                <div className="">
                    ...
                    <h1 className="bg-gradient-to-tr from-lime-400 to-white text-transparent inline-block bg-clip-text xl:text-5xl text-[6rem] font-bold">Simran</h1>
                ...
                <div className="flex flex-col justify-center text-center xl:text-left">
                    ...
                    <p className="opacity-50 text-xl xl:text-md">Crafting intuitive user interfaces, and dynamic web applications to elevate digital experiences.</p>
                </div>
            </div>
